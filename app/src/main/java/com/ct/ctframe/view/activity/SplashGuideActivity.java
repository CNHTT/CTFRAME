...
import com.ct.ctframe.adapter.GuideViewPagerAdapter;
import com.ct.ctframe.utils.PreferenceUtils;

import java.util.ArrayList;
import java.util.List;

public class SplashGuideActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onPause() {
        ...
        PreferenceUtils.setPrefBoolean(this, ConstantValue.FIRST_OPEN, false);
        finish();
    }
